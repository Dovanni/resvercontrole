...
-- 1. Nova RPC de Reconciliação Controlada
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_commercial_records_count FROM public.purchases WHERE empresa_id = v_generic_empresa_id;
...
-- 2. Refatorar handle_new_user para impedir "Minha Empresa" se houver pending ativo
