...
-- Fase 3-I.4 — Hardening pós-laboratório validado
-- Esta migration contém somente ajustes comprovados no vejamais-blog-lab.

begin;

-- Índices para FKs de auditoria sinalizadas pelos Supabase Advisors.
...
-- SELECT: separar anon e authenticated evita policies permissivas sobrepostas.
...
-- UPDATE de posts: uma única policy; o trigger permanece autoritativo para
-- transições, revisão atual, four-eyes e publicação/agendamento.
