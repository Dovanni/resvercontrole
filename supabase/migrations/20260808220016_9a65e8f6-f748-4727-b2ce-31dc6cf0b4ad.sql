...
-- DESCRIÇÃO: Reparo final e transacional da RPC de contexto de assinatura via migration gerenciada.
...
BEGIN
    ...
    -- SECURITY DEFINER permite ler user_company_access sem policy
    SELECT EXISTS (
