-- Fase 1: revogar EXECUTE de todos os papéis
...
-- Fase 2: substituir função com reconciliação de estoque
...
BEGIN
  ...
  -- Trava produtos envolvidos em ordem determinística
  ...
  -- Aplica delta por produto: novo_total - antigo_total
  FOR v_prod IN
    WITH antigos AS (
...
-- Fase 3: reconceder EXECUTE apenas a authenticated
