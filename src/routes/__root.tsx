...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VEJAMAIS ERP — Gestão Comercial e Financeira" },
      { name: "description", content: "VEJAMAIS ERP — plataforma de gestão comercial e financeira para acompanhar vendas, compras, contas e indicadores do seu negócio." },
      { property: "og:title", content: "VEJAMAIS ERP — Gestão Comercial e Financeira" },
      { name: "twitter:title", content: "VEJAMAIS ERP — Gestão Comercial e Financeira" },
      { property: "og:description", content: "VEJAMAIS ERP — plataforma de gestão comercial e financeira para acompanhar vendas, compras, contas e indicadores do seu negócio." },
      { name: "twitter:description", content: "VEJAMAIS ERP — plataforma de gestão comercial e financeira para acompanhar vendas, compras, contas e indicadores do seu negócio." },
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KTR4XQLL');`,
          }}
        />
        <HeadContent />
      </head>
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KTR4XQLL"
            height="0"
            width="0"
