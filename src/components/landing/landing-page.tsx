    ...
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 md:grid-cols-[minmax(0,54fr)_minmax(0,46fr)] md:gap-8 md:px-6 md:py-20 lg:max-w-7xl lg:gap-12 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          <h1
            className="mt-5 max-w-[16ch] text-pretty font-sans text-[2.35rem] font-extrabold text-petrol sm:max-w-[18ch] sm:text-[2.7rem] md:max-w-[20ch] md:text-[3rem] lg:max-w-[22ch] lg:text-[3.3rem] xl:text-[3.5rem]"
